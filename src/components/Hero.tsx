        ...
        <div className="md:w-3/5 md:pr-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <div className="relative group">
              <button className="flex items-center px-6 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <FileTextIcon size={16} className="mr-2" />
                <span>Download Resume</span>
              </button>

              <div className="absolute left-0 mt-2 hidden group-hover:block bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700 rounded-md shadow-lg z-10 min-w-[220px]">
                <a
