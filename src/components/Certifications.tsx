...
export const Certifications: React.FC = () => {
  const certifications = [{
    ...
    logo: 'google-cloud',
    active: true,
    credlyUrl: 'https://www.credly.com/org/google-cloud/badge/google-cloud-certified-associate-cloud-engineer'
  }, {
    ...
    logo: 'github',
    active: true,
    credlyUrl: 'https://www.credly.com/organizations/github/badges'
  }, {
